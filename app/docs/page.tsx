...
export default function DocsPage() {
    return (
        <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-3xl mx-auto flex flex-col items-center justify-center h-full pt-20 pb-20">
                ...
                <motion.p
                    ...
                    className="text-zinc-400 text-sm mb-8 leading-relaxed max-w-xl mx-auto font-light"
                >
                ...
                >
                    {[
                        ...
                        <motion.div
                            ...
                            className="p-4 bg-white/[0.03] hover:bg-white/[0.06] backdrop-blur-sm rounded-xl border border-white/5 hover:border-white/10 transition-all group text-center"
                        >
                ...
                >
                    <Link href="/">
                        <button
                            className="h-12 px-8 bg-transparent text-white border border-zinc-700 rounded-lg hover:bg-white/5 hover:border-kast-teal hover:text-kast-teal font-mono tracking-widest text-xs uppercase flex items-center gap-2 transition-all"
                        >
